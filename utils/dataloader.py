...
class ClipDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        image_path  = os.path.join(self.datasets_path, photo_name.replace("\\", os.path.sep))
    ...
    def get_random_data(self, image, input_shape, jitter=.3, hue=.1, sat=0.7, val=0.3, random=True):
        ...
        #   calculate the parameters of color space transformation
        #---------------------------------#
