...
#---------------------------------------------------------#
#   convert to RGB image to prevent grayscale image from error during prediction
#   the code only supports the prediction of RGB images, so all other types of images will be converted to RGB
#---------------------------------------------------------#
def cvtColor(image):
